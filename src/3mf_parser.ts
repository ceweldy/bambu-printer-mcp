...
import { ThreeMFData, BambuSlicerConfig, ThreeMFMetadata, ThreeMFObject, ThreeMFBuildItem, AMSFilamentMapping, ThreeMFAmsRequirements, ThreeMFPlateObjects } from './types.js';
